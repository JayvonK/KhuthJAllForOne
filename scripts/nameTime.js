...
nTRun.addEventListener('click', async (event) => {
    if (nTInput1.value !== "" && nTInput2.value !== "") {
        ...
        nTDiv.className = "lg:h-[275px] lg:w-[1066px] w-96 h-72 bg-[#161A30] flex lg:items-center justify-center hidden";
...
nTAgain.addEventListener('click', (event) => {
    nTDiv.className = "lg:h-[275px] lg:w-[1066px] w-96 h-72 bg-[#161A30] flex lg:items-center justify-center ";
    nTAppear.className = "lg:h-[275px] lg:w-[1066px] w-96 h-72 bg-[#161A30] flex lg:items-center justify-center hidden";
    nTInput1.value = "";
    nTInput2.value = "";
